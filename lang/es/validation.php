...
return [
    ...
    'attributes' => [
        ...
        'user_id' => 'usuario',
        'step_id' => 'actividad',
        'appraisal_id' => 'encargo',
        'appraisal_plate' => 'encargo/matrícula',
        'plans' => 'procesos',
        'clients' => 'clientes',
        'assigned_date' => 'Fecha Asignación',
        'start_date' => 'Fecha Inicio',
        'finish_date' => 'Fecha Finalización',
        'department_id' => 'departamento',
        'level' => 'nivel',
        'communication_channel' => 'canal',
        'communication_state' => 'estado',
        'to' => 'para',
        ...
        'company' => 'compañía',
        'appraisal_client' => 'expediente',
        'appraisal_abr' => 'exp.',
        'proof_of_payment' => 'comp. pago',
        'appraisal' => 'encargo',
        'franchise' => 'franquicia',
        'department' => 'departamento',
        'levels' => 'niveles',
        'step_ids' => 'actividades',
        'vehicle_in_garage' => 'Vehículo en taller',
        'vehicle_state' => 'Estado del vehículo',
        'next_management_date' => 'Fecha siguiente gestión',
        'repair_end_date' => 'Fecha fin de reparación',
        'garage_name' => 'Nombre taller',
        'location_province' => 'Localidad, provincia',
        'is_routine' => 'Rutina',
        'is_parent' => 'Es subproceso',
        'plate' => 'Matrícula',
        'external_id' => 'Id externo',
        'external_sub_id' => 'Sub Id externo',
    ],
];
